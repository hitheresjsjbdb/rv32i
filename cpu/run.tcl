...
analyze -format verilog -define {SRAM SYNTHESIS RF_OBSERVE CTRL_OBSERVE} $rtl_files
elaborate $TOP
current_design $TOP
...
set preserve_obs_cells [get_cells -quiet -hier *U_*OBS*]
if {[sizeof_collection $preserve_obs_cells] > 0} {
    catch {set_dont_touch $preserve_obs_cells true}
    catch {set_ungroup $preserve_obs_cells false}
}

set preserve_arch_state [get_cells -quiet -hier {
    U_ControlUnit/U_IF_PC
    U_ControlUnit/U_IF_PCA4
    U_ControlUnit/U_IFID_*
    U_ControlUnit/U_branch
    U_ControlUnit/U_NPCOp
    U_ControlUnit/U_IDEX_*
    U_ControlUnit/U_EXMEM*
    U_ControlUnit/U_MEMWB*
    U_ControlUnit/U_MEMstall*
    U_RF/register_reg*
}]
if {[sizeof_collection $preserve_arch_state] > 0} {
    catch {set_dont_retime $preserve_arch_state true}
}
