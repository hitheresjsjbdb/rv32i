...
std::vector<Pattern> instPattern {
    ...
    { "0000000 ????? ????? 001 ????? 01100 11", Name::SLL,    Type::R, []() { R(rd) = R(rs1) << (R(rs2) & 0x1f); } },
    { "0000000 ????? ????? 101 ????? 01100 11", Name::SRL,    Type::R, []() { R(rd) = R(rs1) >> (R(rs2) & 0x1f); } },
    { "0100000 ????? ????? 101 ????? 01100 11", Name::SRA,    Type::R, []() { R(rd) = static_cast<sword_t>(R(rs1)) >> (R(rs2) & 0x1f); } },
