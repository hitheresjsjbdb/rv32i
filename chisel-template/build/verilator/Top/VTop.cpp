...
VTop::VTop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , io_ctrlBranchToPc{vlSymsp->TOP.io_ctrlBranchToPc}
    , io_ctrlJumpToPc{vlSymsp->TOP.io_ctrlJumpToPc}
    , io_resultBranch{vlSymsp->TOP.io_resultBranch}
    , io_instWriteEn{vlSymsp->TOP.io_instWriteEn}
    , io_dataWriteEn{vlSymsp->TOP.io_dataWriteEn}
    ...
    , io_instWriteAddr{vlSymsp->TOP.io_instWriteAddr}
    , io_instWriteData{vlSymsp->TOP.io_instWriteData}
    , io_dataWriteAddr{vlSymsp->TOP.io_dataWriteAddr}
    , io_dataWriteData{vlSymsp->TOP.io_dataWriteData}
    , rootp{&(vlSymsp->TOP)}
{
