error id: file://<WORKSPACE>/src/main/scala/rv32I/Top.scala:
file://<WORKSPACE>/src/main/scala/rv32I/Top.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/decoder.
	 -chisel3/util/decoder.
	 -config/Configs.decoder.
	 -utils/decoder.
	 -decoder.
	 -scala/Predef.decoder.
offset: 2111
uri: file://<WORKSPACE>/src/main/scala/rv32I/Top.scala
text:
```scala
package rv32I
...
class Top extends Module {
    ...
    io.bundleCtrl <> de@@coder.io.bundleCtrl
