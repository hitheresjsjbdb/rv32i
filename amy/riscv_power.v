...
assign ex_rs1_fwd = idex_valid ? ((exmem_can_fwd && (exmem_rd == idex_rs1)) ? exmem_fwd_data :
                                  (memwb_can_fwd && (memwb_rd == idex_rs1)) ? memwb_fwd_data :
                                                                               idex_rs1_val)
                               : 32'b0;
assign ex_rs2_fwd = idex_valid ? ((exmem_can_fwd && (exmem_rd == idex_rs2)) ? exmem_fwd_data :
